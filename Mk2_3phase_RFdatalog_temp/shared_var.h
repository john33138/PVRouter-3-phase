...
inline volatile uint16_t overrideBitmask{ 0 };       /**< combined bitmask of all active override pins for local loads/relays */
inline volatile uint8_t remoteOverrideBitmask{ 0 };  /**< combined bitmask of all active override pins for remote loads */
